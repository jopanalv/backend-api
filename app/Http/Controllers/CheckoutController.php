...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('checkouts.id', 'products.image','users.id AS user_id','users.address', 'users.fullname', 'users.email', 'users.handphone' ,'products.name', 'carts.quantity', 'carts.duration', 'carts.total', 'checkouts.proof', 'checkouts.status', 'carts.created_at')
        ->get();
